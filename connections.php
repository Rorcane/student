...
<div class="container-fluid">
  ...
  <div class="col-md-10 p-4">
    <h2 class="mb-4"><i class=""></i>Связи</h2>
        ...
        <div class="card connection-card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img src="user1.jpg" width="50" class="rounded-circle me-3">
              <div>
                <h6>Иван Петров</h6>
                <span class="text-muted">HR-менеджер</span>
              </div>
            </div>
            <button class="btn btn-outline-primary w-100 mt-3">Написать</button>
          </div>
        </div>
      </div>
    </div>
