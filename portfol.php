    ...
    <div class="row">
        ...
        <div class="col-md-2 bg-white vh-100 border-end p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a href="portfol.php" class="nav-link active">
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="service-card p-4 mb-4">
                <div class="card-header bg-transparent border-0 pb-3">
                    <h5><i class="fas fa-plus-circle me-2"></i>Добавить новую информацию</h5>
                </div>
                <form action="save_service.php" method="post">
                    <div class="mb-4">
                        <label class="form-label">Название информаций</label>
                        <input type="text" class="form-control form-control-lg" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Описание информаций</label>
            ...
            <div class="service-card p-4">
                <div class="card-header bg-transparent border-0 pb-3">
                    <h5><i class="fas fa-list me-2"></i>Мои достижения</h5>
                </div>
