...
<div class="container-fluid">
  ...
  <!-- Общая структура как в services.php -->
  <div class="col-md-10 p-4">
    <h2 class="mb-4"><i class=""></i>Портфолио</h2>
    
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card portfolio-item">
          <img src="project1.jpg" class="card-img-top" alt="Проект 1">
          <div class="card-body">
            <h5>HR-платформа</h5>
            <p>Полная автоматизация подбора персонала</p>
            <div class="badge bg-primary">AI Integration</div>
          </div>
        </div>
      </div>
